...
namespace PuzzLangLib {
    ...
    class GameState {
        ...
        internal bool IsAgaining {
            get { return _result == StateResult.Againing; }
        }

        internal bool IsFinished {
            get { return _result == StateResult.Finished; }
        }

        internal bool HasChanged {
            get { return _levelstate.ChangesCount > 0; }
        }

        internal int AgainCount { get; set; }

        internal IList<int> PlayerIndexes {
        ...
        GameDef _gamedef {
            get { return _model.GameDef; }
        }

        Random _rng;


        static readonly Dictionary<CommandName, StateResult> _commandresultlookup =
            new Dictionary<CommandName, StateResult>() {
        ...
        internal static GameState Create(GameModel model, Level level, GameState parent) {
            ...
            var gs = new GameState {
                ...
                PuzzleObjects = (parent == null)
                    ? new Dictionary<int, PuzzleObject>()
