...
namespace PuzzLangLib {
    ...
    class RuleAtom {
        ...
        internal bool IsEllipsis {
            get { return Symbol == Ellipsis; }
        }

        internal bool IsRandom {
            get { return Direction == Direction.Random; }
        }

        internal bool HasObject {
            get { return Symbol.ObjectIds.Count > 0; }
        }
    ...
    class AtomicRule {
        ...
        public bool IsFinal {
            get { return Prefixes.Contains(RulePrefix.Final); }
        }
    ...
    class ObjectSymbol {
        ...
        public bool IsObject {
            get { return Kind != SymbolKind.None; }
        }
        ...
        internal void SetVarRef(int varid) {
            if (Kind != SymbolKind.RefObject)
                throw Error.Assert($"ref {varid}");
    ...
    internal class ParseManager {
        ...
        internal IList<AtomicRule> AtomicRules {
            get { return _atomicrules; }
        }

        internal IEnumerable<ObjectSymbol> Symbols {
            get { return _symbols.Values; }
        }

        int _linenumber {
            get { return PegParser.LineNumber; }
        }
        ...
        Dictionary<string, ObjectSymbol> _symbols =
            new Dictionary<string, ObjectSymbol>(StringComparer.OrdinalIgnoreCase);
        ...
        internal Direction ParseDirection(string value) {
            return (value == null || value.EndsWith("_"))
                ? Direction.None
        ...
        internal RulePrefix ParseRulePrefix(string value) {
            if (value == null || value.EndsWith("_"))
                return RulePrefix.None;
            if (value == "+")
                return RulePrefix.Plus_;
        ...
        ObjectSymbol CollectObjects(IEnumerable<ObjectSymbol> syms) {
            ...
            if (kinds.Contains(SymbolKind.Mixed))
                throw Error.Assert("stored mixed");
        ...
        internal void AddSound(string trigger, string seed, string objct, IList<string> directions) {
            ...
            if (trig <= MaxWithObject_) {
                ...
                if (directions != null && directions.Count > 0)
                    ...
                    _gamedef.AddObjectSound(trig, obj, null, seed);
            } else
                _gamedef.AddGameSound(trig, seed);
        }
        ...
        internal CommandCall CreateCommandCall(string ident, ScriptFunctionCall call, string argument) {
            ...
            if (sound >= MinSound_) {
                ...
                if (seed == null)
                    CompileWarn("sound not defined: {0}", ident);
        ...
        internal RuleAtom CreateRuleCell(string noflag, string direction, string prefix, string ident,
        ...
        internal void AddLevel(IList<string> lines) {
            if (_gamedef.Background == null) {
                ...
                if (background == null) {
                    ...
                    _gamedef.Background = background.ObjectIds;
            }
        ...
        internal void CheckData() {
            ...
            if (player == null && clickable == null)
                CompileError("must define player or clickable");
            if (player != null) {
        ...
        internal void CompileError(string fmt, params object[] args) {
            ErrorCount++;
            throw new DOLEException(
                "*** '{0}' at {1}: compile error: {2}".Fmt(_sourcename, _linenumber, String.Format(fmt, args)));
        }

        internal void CompileWarn(string fmt, params object[] args) {
            _out.WriteLine("*** '{0}' at {1}: compile warning: {2}", _sourcename, _linenumber,
