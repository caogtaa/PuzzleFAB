...
namespace PuzzLangLib {
    ...
    public enum InputEvent {
        ...
        Left,
        Down,
        Right, // arrow player movements
        Action,
        Reaction, // other player movements
        Fire1,
        Fire2,
        Fire3,
        Hover, // click/mouse movements
    ...
    internal enum Direction {
        ...
        Down,
        Left,
        Right, // basic directions
        Horizontal,
        Vertical,
        Orthogonal, // combos of the above
        ...
        Fire2,
        Fire3,
        Hover, // input events treated as direction
    ...
    public class GameDef {
        ...
        public int ObjectCount {
            get { return PuzzleObjects.Count; }
        }

        public int LevelCount {
            get { return LevelIndex.Count; }
        }
        ...
        internal Dictionary<OptionSetting, Pair<int, int>> PairSettings =
            new Dictionary<OptionSetting, Pair<int, int>>(); // .NET 3.5
        ...
        internal void AddObjectSound(SoundTrigger trigger, IList<int> objects, IEnumerable<Direction> directions,
            string seed) {
        ...
        internal void AddWinCondition(MatchOperator action, IList<int> objects, IList<int> others,
